...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars.packages",
                     "org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.1")  # Spark-Kafka integration
             .config("spark.jars",
                     "/Users/nishanthreddy/Documents/Semester#2/DATA#603/Project/realtime-voting/postgresql-42.7.1.jar")  # PostgreSQL driver
             .config("spark.sql.adaptive.enabled", "false")  # Disable adaptive query execution
             .config("spark.driver.extraJavaOptions", "-XX:ReservedCodeCacheSize=256m")  # Set CodeCache size
             .getOrCreate())
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/nishanthreddy/Documents/Semester#2/DATA#603/Project/realtime-voting/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/nishanthreddy/Documents/Semester#2/DATA#603/Project/realtime-voting/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
