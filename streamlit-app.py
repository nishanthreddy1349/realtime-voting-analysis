...
st.set_page_config(page_title="Real-time Election Dashboard", page_icon=":bar_chart:", layout="wide")
...
def load_image(image_path):
    try:
        ...
        st.error(f"Image file not found or cannot be accessed: {image_path}")
        return None
